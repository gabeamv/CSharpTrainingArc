...
| Doc | Contents |
|---|---|
| [api-reference.md](api-reference.md) | Web API models, routes, request/response examples |
| [frontend-architecture.md](frontend-architecture.md) | WPF MVVM structure, views, view models, services, navigation |
| [encryption-and-data-flow.md](encryption-and-data-flow.md) | Hybrid RSA+AES-GCM scheme, signing/verification, end-to-end data flow for each feature |
| [authentication-and-keys.md](authentication-and-keys.md) | Registration/login, RSA key generation, Windows CNG key storage & certificate store |
| [database.md](database.md) | PostgreSQL/EF Core integration, schema, migrations |
| [security-weaknesses.md](security-weaknesses.md) | Known weaknesses and suggested improvements |
